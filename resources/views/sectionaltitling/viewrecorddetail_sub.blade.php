                            ...
                            <div class="p-5">
                                ...
                                <div class="bg-blue-50 p-4 rounded-lg mb-6">
                                    <div class="flex items-center mb-3">
                                        ...
                                        <span class="text-blue-800 font-medium">This is a Standalone Unit Application</span>
                                    </div>
                                    <p class="text-blue-700 text-sm">
                                        SUA applications are independent unit applications that do not require a mother application. 
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                                    ...
                                    <div>
                                        ...
                                        <p class="font-semibold text-gray-900">{{ ucfirst($application->land_use ?? 'N/A') }}</p>
                                    </div>
                                    <div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                                    ...
                                    <div>
                                        ...
                                        <p>{{ $application->created_at ? date('F j, Y', strtotime($application->created_at)) : 'N/A' }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        @if ($application->applicant_type == 'corporate')
                                            <div class="bg-blue-50 border-l-4 border-blue-400 p-4 rounded-md">
                                                <div class="flex items-center">
                                                    ...
                                                    <div>
                                                        @if(isset($application->is_sua_unit) && $application->is_sua_unit == 1)
                                                            <p class="font-medium text-blue-800">{{ $application->corporate_name ?? 'Corporate Entity' }}</p>
                                                            <p class="text-sm text-gray-600">RC: {{ $application->rc_number ?? 'Not Provided' }}</p>
                                                        @else
                            ...
                            @if(isset($application->is_sua_unit) && $application->is_sua_unit == 1)
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                                    <div>
                                        ...
                                        <p class="text-blue-600 font-semibold">{{ $application->unit_type ?? 'N/A' }}</p>
                                    </div>
                                    <div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                                    <div>
                                        <p class="text-sm text-gray-600 font-medium">Land Use:</p>
                                        <p class="text-blue-600 font-semibold">{{ ucfirst($application->land_use ?? 'N/A') }}</p>
                                    </div>
                                    <div>
                        ...
                        <div class="p-5">
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div>
                                    ...
                                    <p class="font-medium">{{ $application->payment_date ? date('F j, Y', strtotime($application->payment_date)) : 'Not Paid' }}</p>
                                </div>
                                <div>
