                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <span class="truncate max-w-[120px]">
                                                ...
                                                @elseif($PrimaryApplication->first_name || $PrimaryApplication->surname)
                                                   {{ strtoupper($PrimaryApplication->applicant_title) }} {{ $PrimaryApplication->first_name }} {{ $PrimaryApplication->surname }}
                                                @else
                                                    Unknown Owner
                                                @endif
                                            </span>
        ...
        <script>
            $(document).ready(function() {
                ...
                $('#statusFilter').on('change', function() {
                    ...
                    if (status === 'All...') {
                        table.columns([8, 9]).search('').draw(); // Clear search on both status columns
                    } else {
                        // Search in both planning recommendation and director's approval columns
