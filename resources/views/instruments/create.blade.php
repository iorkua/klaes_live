            ...
            <div class="card p-6">
                ...
                <div class="grid grid-cols-4 gap-3 mb-6">
                    ...
                    <button class="instrument-type-btn p-2 border rounded-lg text-center bg-slate-50 border-slate-200 hover:bg-slate-100" data-type="devolution-order">
                        ...
                        <p class="text-xs text-black text-justify flex items-start gap-2"><span class="inline-flex items-center justify-center w-6 h-6 bg-slate-600 text-white rounded-full text-xs font-bold flex-shrink-0 mt-0.5">11</span>A court-issued legal instrument used to transfer property ownership from a deceased person's estate to their rightful heirs or beneficiaries.</p>
                    </button>
                    <button class="instrument-type-btn p-2 border rounded-lg text-center bg-emerald-50 border-emerald-200 hover:bg-emerald-100" data-type="deed-of-gift">
                        ...
                        <p class="text-xs text-black text-justify flex items-start gap-2"><span class="inline-flex items-center justify-center w-6 h-6 bg-emerald-600 text-white rounded-full text-xs font-bold flex-shrink-0 mt-0.5">12</span>A legal document that transfers ownership of property from a donor (giver) to a donee (receiver) without monetary consideration, typically as a gift.</p>
                    </button>
                    <button class="instrument-type-btn p-2 border rounded-lg text-center bg-orange-50 border-orange-200 hover:bg-orange-100" data-type="occupancy-permit">
                        ...
                        <p class="text-xs text-black text-justify flex items-start gap-2"><span class="inline-flex items-center justify-center w-6 h-6 bg-orange-600 text-white rounded-full text-xs font-bold flex-shrink-0 mt-0.5">13</span>An official document issued by Kano State Government granting permission to occupy and use a specific property or land for designated purposes.</p>
                    </button>
                </div>
            </div>
        </div>
        ...
        <div class="dialog-content animate-fade-in">
            ...
            <form id="registration-form" class="p-6 space-y-6">
                ...
                <div class="space-y-4 border rounded-md p-4 bg-gray-50">
                    ...
                    <div class="flex items-center space-x-2 mb-4 hidden">
                ...
                <div id="registration-details-section" class="space-y-4 border rounded-md p-4 bg-gray-50">
                    ...
                    <div id="rootRegNoSection" class="space-y-2">
                        ...
                        <div class="flex gap-2">
                            <input   name="rootRegNo" class="input" placeholder="Enter root registration number" required>
                            <button type="button" id="generate-root-btn" class="btn btn-outline hidden" title="Generate next particulars number">
