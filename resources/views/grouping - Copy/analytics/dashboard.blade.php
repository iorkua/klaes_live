...
@section('content')
    ...
    <div class="flex-1 overflow-auto">
        ...
        <div class="p-6">
            <div class="grouping-analytics space-y-6" x-data="groupingAnalyticsDashboard()" x-init="refreshStats()">
                ...
                <div class="refresh-controls">
                    <button type="button" class="refresh-button" @click="refreshStats()" :disabled="isRefreshing">
