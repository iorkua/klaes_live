            ...
            <div class="bg-white rounded-lg shadow-lg p-6 max-w-4xl mx-auto">
                <div class="mb-6">
                    <div class="flex items-center gap-3 mb-2">
                        <i data-lucide="file-plus" class="h-5 w-5 text-blue-600"></i>
                        <h2 class="text-xl font-semibold text-gray-800">Create New File Index</h2>
                    </div>
                    <p class="text-gray-600">Enter the details for the new file to be indexed</p>
                </div>
