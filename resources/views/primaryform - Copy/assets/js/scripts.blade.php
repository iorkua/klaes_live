...
<script src="{{ asset('js/primaryform/utilities.js') }}"></script>
<script src="{{ asset('js/primaryform/states-lga.js') }}"></script>
<script src="{{ asset('js/primaryform/navigation.js') }}"></script>
<script src="{{ asset('js/primaryform/buyers.js') }}"></script>
<script src="{{ asset('js/primaryform/summary.js') }}"></script>
