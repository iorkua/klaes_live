...
<div id="property-form-dialog" class="dialog-overlay hidden">
    <div class="dialog-content property-form-content">
        <div class="flex justify-between items-center mb-4">
            <h2 id="form-title" class="text-xl font-bold" x-text="formMode === 'index' ? 'Index Card' : 'Add New Property Record'" x-init="console.log('Header initialized with mode:', formMode)"></h2>
...
<div x-data="{
    // Form mode: 'property' for Property Record, 'index' for Index Card
    formMode: 'property',
    ...
    init() {
        console.log('Alpine.js component initialized with formMode:', this.formMode);
        
        // Listen for form mode changes
        this.$el.addEventListener('form-mode-changed', (event) => {
            console.log('Form mode change event received:', event.detail.mode);
            this.formMode = event.detail.mode;
            this.$nextTick(() => {
                console.log('Form mode updated to:', this.formMode);
            });
        });
    },
    ...
    submitForm() {
        ...
        // Index Card mode - no additional validation required
        if (this.formMode === 'index') {
            console.log('Index Card mode - proceeding without additional field validation');
        }
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            <div>
                                <label for="tp_no_prop" class="text-xs text-gray-600">
                                    TP No 
                                    <span x-show="formMode === 'property'" class="text-gray-400">(optional)</span>
                                </label>
                                <input id="tp_no_prop" name="tp_no" x-model="tpNo" type="text" 
                                       :class="formMode === 'index' ? 'form-input text-sm property-input border-blue-300 focus:border-blue-500' : 'form-input text-sm property-input'"
                                       :placeholder="formMode === 'index' ? 'Enter TP number (required)' : 'Enter TP number (optional)'">
                            </div>
                            <div>
                                ...
                                <input id="lpkn_no_prop" name="lpkn_no" x-model="lpknNo" type="text" 
                                       :class="formMode === 'index' ? 'form-input text-sm property-input border-blue-300 focus:border-blue-500' : 'form-input text-sm property-input'"
                                       :placeholder="formMode === 'index' ? 'Enter LPKN number (required)' : 'Enter LPKN number (optional)'">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            <div>
                                ...
                                <input id="approved_plan_no_prop" name="approved_plan_no" x-model="approvedPlanNo" type="text" 
                                       :class="formMode === 'index' ? 'form-input text-sm property-input border-blue-300 focus:border-blue-500' : 'form-input text-sm property-input'"
                                       :placeholder="formMode === 'index' ? 'Enter approved plan number (required)' : 'Enter approved plan number (optional)'">
                            </div>
                            <div>
                                ...
                                <input id="plot_size_prop" name="plot_size" x-model="plotSize" type="text" 
                                       :class="formMode === 'index' ? 'form-input text-sm property-input border-blue-300 focus:border-blue-500' : 'form-input text-sm property-input'"
                                       :placeholder="formMode === 'index' ? 'Enter plot size (required)' : 'Enter plot size (optional)'">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            <div>
                                ...
                                <input id="date_recommended_prop" name="date_recommended" x-model="dateRecommended" type="date" 
                                       :class="formMode === 'index' ? 'form-input text-sm property-input border-blue-300 focus:border-blue-500' : 'form-input text-sm property-input'">
                            </div>
                            <div>
                                ...
                                <input id="date_approved_prop" name="date_approved" x-model="dateApproved" type="date" 
                                       :class="formMode === 'index' ? 'form-input text-sm property-input border-blue-300 focus:border-blue-500' : 'form-input text-sm property-input'">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            <div>
                                ...
                                <input id="lease_begins_prop" name="lease_begins" x-model="leaseBegins" type="date" 
                                       :class="formMode === 'index' ? 'form-input text-sm property-input border-blue-300 focus:border-blue-500' : 'form-input text-sm property-input'">
                            </div>
                            <div>
                                ...
                                <input id="lease_expires_prop" name="lease_expires" x-model="leaseExpires" type="date" 
                                       :class="formMode === 'index' ? 'form-input text-sm property-input border-blue-300 focus:border-blue-500' : 'form-input text-sm property-input'">
                            </div>
                        </div>
   @include('components.metricSheetNo2')
                        <!-- Additional Index Card specific fields -->
                        <div class="grid grid-cols-1 gap-3">
                            <div>
                                ...
                                <input id="scale_prop" name="scale" x-model="scale" type="text" 
                                       :class="formMode === 'index' ? 'form-input text-sm property-input border-blue-300 focus:border-blue-500' : 'form-input text-sm property-input'"
                                       :placeholder="formMode === 'index' ? 'Enter scale (required)' : 'Enter scale (optional)'">
                            </div>
                        </div>
                    </div>
                </div>
