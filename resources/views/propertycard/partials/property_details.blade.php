    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6" id="property-cards-container">
                ...
                <div class="border-2 border-dashed border-blue-400 rounded-lg shadow-lg cursor-pointer hover:bg-blue-50 transition-all flex flex-col items-center justify-center p-8 bg-gradient-to-br from-blue-50 to-white hidden" id="add-property-card">
...
<br>
<hr>
<button type="button" class="btn btn-success flex items-center whitespace-nowrap shadow-lg border-2 border-green-400 bg-gradient-to-r from-green-500 to-green-700 text-white hover:from-green-600 hover:to-green-800 transition-all px-4 py-2 rounded-md text-sm mr-3" onclick="window.location.href='{{ route('propertycard.cofo') }}'">
